  ...
  return (
    <footer aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-2 xl:gap-8">
          <div className="space-y-8">
            <div className="flex items-center space-x-2">
              <img src={logo} alt="Mujiib Trading Hub" className="h-12 w-auto" />
              <span className="text-[#C3975A] font-bold font-mont text-lg">
                Mujiib Trading Hub
              </span>
            </div>
        ...
        <div className="mt-16 flex flex-col justify-between space-y-6 border-t border-neutral-900/10 pt-8">
          <p className="text-xs leading-5 text-neutral-500">
            &copy; 2020 Your Mujiib Trading Hub, Inc. All rights reserved.
          </p>
