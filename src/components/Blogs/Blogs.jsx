    ...
    <div className="mx-auto mt-24 max-w-7xl px-4 sm:mt-32 sm:px-6 lg:mt-40 lg:px-8">
      <div className="block items-end justify-between lg:flex">
        <div className="flex max-w-4xl flex-col space-y-7">
          <h3 className="text-lg font-medium uppercase tracking-wide text-neutral-900">
            Market Insights & Trade Breakdowns
          </h3>

          <h2 className="text-4xl font-semibold leading-tight tracking-wide text-neutral-900">
            Stay Updated with Real-Time Trading Knowledge and Trends
          </h2>

          <p className="max-w-xl text-lg text-neutral-600">
            Our blog delivers sharp, actionable insights to help you stay ahead of the market. From in-depth trade breakdowns and SMC strategy tips to macroeconomic updates and psychology
             hacks — this is where we break it all down for traders who want to stay informed and improve continuously..
          </p>
        </div>
      ...
      <div className="mx-auto mt-10 max-w-md sm:mt-14 md:max-w-2xl lg:mt-20 lg:max-w-none">
        <dl className="grid grid-cols-1 gap-x-8 gap-y-16 md:grid-cols-2 xl:grid-cols-3">
          {posts.map((post) => (
            <div
              key={post.id}
              className="flex flex-col rounded-md border border-neutral-400 shadow-sm"
            >
              <img
                src={post.imgSrc}
                alt={post.alt}
